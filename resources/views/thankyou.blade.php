    ...
    <div class="h-screen bg-gray-200 flex justify-center items-center ">
        <div class="bg-white md:w-3/5 h-4/5 rounded-lg mx-4 shadow-xl flex flex-col justify-start items-center gap-8">
            <div class="w-32 mt-10">
                <img loading="lazy"  src="/images/logos/logoKP.png" alt="">
            </div>
            <div class="">
                <h1 class="font-car font-bold text-gray-900 text-3xl text-center"> PT. Industri Golf Indonesia</h1>
                <p class="font-car text-center">Terima Kasih Sudah Menyewa Mobil Golf Di Kami, HAVE A NICE DAY ☺️ </p>
            </div>
            <div class="relative bg-gray-200 md:w-3/5 m-4 md:mt-10">
                ...
                <div class="p-3">
                    ...
                    <p class="text-lg font-car text-gray-600 text-justify">Anda dapat pergi ke salah satu toko kami yang dekat dengan Anda dan menunjukkan faktur reservasi Anda (digital atau cetak) dan kemudian membayar serta mendapatkan mobil Anda</p>
